...
Welcome to this storyboard, which has been designed to provide an overview of the ethical frameworks in place or in development to guide the use of artificial intelligence in mental health care and research.

Should AI be used for this purpose?

### Mental Health in Sotland
...
### Apps for mental health care {data-commentary-width=400}

<div class="knitr-options" data-fig-width="576" data-fig-height="460"></div>

```{=html}
<div id="htmlwidget-57a8c2536398603e66ee" style="width:576px;height:460.8px;" class="DiagrammeR html-widget"></div>
<script type="application/json" data-for="htmlwidget-57a8c2536398603e66ee">{"x":{"diagram":"\ngraph TB\n    A(Mental Health Apps) --> B(UB-OK/ Alli-chat)\n    B --> C(Mental & physical <br> health)\n    C --> D(AI-based)\n    C --> E(Therapeutic <br> conversation)\n    D --> F(Natural <br> language <br> understanding?)\n    A --> G(Daylight)\n    G --> H(Worry <br> Anxiety <br> Management of <br> General Anxiety Disorder)\n    H --> I(Fully automated)\n    H --> J(Based on CBT)\n    A --> K(Sleepio)\n    K --> L(Insomnia)\n    L --> M(AI-based)\n    L --> N(Tailored CBT for <br> insomnia: CBT-I)\n    N --> O(Six-week self-help <br> programme)\n    J --> P(Six-week self-help <br> programme)\n    E --> Q(Ongoing interaction)\n"},"evals":[],"jsHooks":[]}</script>
```
